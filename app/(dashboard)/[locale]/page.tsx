  ...
  return (
    <div className="flex flex-col gap-6 p-6 md:gap-8">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">{dictionary.common.welcome} to TradeNavigatorPro</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className={`text-xs ${metrics.costImpact.increasing ? 'text-green-500' : 'text-red-500'} flex items-center`}>
              {metrics.costImpact.increasing ? <Icons.arrowUp className="mr-1 h-3 w-3" /> : <Icons.arrowDown className="mr-1 h-3 w-3" />}
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{metrics.tariffChanges.value}</div>
            <p className={`text-xs ${metrics.tariffChanges.increasing ? 'text-amber-500' : 'text-green-500'} flex items-center`}>
              {metrics.tariffChanges.increasing ? <Icons.arrowUp className="mr-1 h-3 w-3" /> : <Icons.arrowDown className="mr-1 h-3 w-3" />}
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{metrics.supplierAlternatives.value}</div>
            <p className={`text-xs ${metrics.supplierAlternatives.increasing ? 'text-green-500' : 'text-red-500'} flex items-center`}>
              {metrics.supplierAlternatives.increasing ? <Icons.arrowUp className="mr-1 h-3 w-3" /> : <Icons.arrowDown className="mr-1 h-3 w-3" />}
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{metrics.dutyDrawbacks.value}</div>
            <p className={`text-xs ${metrics.dutyDrawbacks.increasing ? 'text-green-500' : 'text-red-500'} flex items-center`}>
              {metrics.dutyDrawbacks.increasing ? <Icons.arrowUp className="mr-1 h-3 w-3" /> : <Icons.arrowDown className="mr-1 h-3 w-3" />}
      ...
      {/* Core applications */}
      <div>
        <h2 className="mb-4 text-xl font-semibold tracking-tight">{dictionary.navigation.applications}</h2>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between space-x-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="text-sm font-medium">Cost calculation completed</p>
            ...
            <div className="flex items-center justify-between space-x-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Yesterday, 2:20 PM</p>
                </div>
              </div>
              <Button variant="ghost" size="sm">
                <Icons.eye className="h-4 w-4" />
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {recentAlerts.map((alert) => {
              const alertIcon = 
                alert.type === 'tariff' ? <Icons.alertTriangle className="h-4 w-4 text-red-500" /> :
                alert.type === 'supplier' ? <Icons.network className="h-4 w-4 text-blue-500" /> :
                <Icons.fileCheck className="h-4 w-4 text-green-500" />
              
              const impactBadgeClass = 
                alert.impact === 'High' ? 'bg-red-100 text-red-700 border-red-200' :
                alert.impact === 'Medium' ? 'bg-amber-100 text-amber-700 border-amber-200' :
