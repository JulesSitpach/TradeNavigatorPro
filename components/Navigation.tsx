...
export default function Navigation() {
  ...
  return (
    <nav className="bg-gray-900 text-white" data-oid=":atyvre">
      <div
      ...
      >
        ...
        >
          {/* Logo */}
          <div className="flex items-center" data-oid="f1ni6zl">
            <Link
              href="/en"
          ...
          {/* Mobile menu button */}
          <div className="md:hidden" data-oid="fzsk9ej">
            <button
              type="button"
